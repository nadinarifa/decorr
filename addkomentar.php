...
// Pastikan pengguna sudah login dan memiliki ID pengguna (id_user)
if (!isset($_SESSION['id_user'])) {
	echo "Anda harus login untuk memberi komentar.";
	exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!empty($id_produk) && !empty($isi_komentar)) {
		// Menyimpan komentar dengan id_user
		$stmt = $conn->prepare("INSERT INTO tb_komentar (id_produk, id_user, isi_komentar) VALUES (?, ?, ?)");
		$stmt->bind_param("iis", $id_produk, $id_user, $isi_komentar);

		if ($stmt->execute()) {
			header("Location: product-detail.php?id=$id_produk"); // Redirect ke halaman produk
			exit();
		} else {
			echo "Error saat menambahkan komentar: " . $stmt->error;
		}
			...
			<div class="row">
				<div class="col-xl-12 col-xxl-12">
					<div class="card">
						...
						<div class="card-body">
							<form id="formKomentar" action="addkomentar.php" method="POST">
								<div class="row">
									<!-- Pilih Produk -->
									<div class="col-lg-6 mb-3">
										<div class="form-group">
											...
											<select class="form-select" name="id_produk" required>
												...
												$result_produk = $conn->query("SELECT * FROM tb_produk");
												if ($result_produk->num_rows > 0) {
													while ($produk = $result_produk->fetch_assoc()) {
														echo '<option value="' . $produk['id_produk'] . '">' . htmlspecialchars($produk['nama_produk']) . '</option>';
													}
												} else {
									...
									<div class="col-lg-12 mb-3">
										<div class="form-group">
											...
											<textarea name="isi_komentar" class="form-control" style="height: 200px;"
									...
									<div class="col-lg-12">
										...
										<a href="product-detail.php?id=<?php echo $id_produk; ?>"
