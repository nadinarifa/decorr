<?php
// Koneksi ke database
include 'includes/db.php'; // Pastikan path ini benar sesuai dengan file koneksi Anda
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	// SQL query untuk insert data ke tb_user
	$sql = "INSERT INTO tb_user (username, email, alamat, nomor_telepon, password) 
            VALUES ('$username', '$email', '$alamat', '$nomor_telepon', '$hashed_password')";

	// Eksekusi query
	if (mysqli_query($conn, $sql)) {
		// Redirect ke halaman user.php setelah berhasil simpan data
			...
			<div class="row">
				<div class="col-xl-12 col-xxl-12">
					<div class="card">
						...
						<div class="card-body">
							<form id="formUser" action="adduser.php" method="POST">
								<div class="row">
									<!-- Username -->
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="password" id="passwordField" name="password"
													class="form-control" placeholder="Enter password" minlength="8"
													required>
											...
											<small class="form-text text-muted">Password harus minimal 8
												karakter.</small>
										</div>
									</div>
