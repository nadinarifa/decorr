...
// Query untuk mengambil data dari tb_komentar dengan join ke tb_produk dan tb_user
$query = "SELECT tb_komentar.id_komentar, tb_produk.nama_produk, tb_user.username, tb_komentar.komentar, tb_komentar.tanggal_komentar 
          FROM tb_komentar 
    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-end mb-3">
                <a href="addkomentar.php" class="btn btn-primary btn-sm">
                            ...
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                        <tr data-id="<?php echo htmlspecialchars($row['id_komentar']); ?>">
                                            <td><?php echo htmlspecialchars($row['nama_produk']); ?></td>
                                            <td><?php echo htmlspecialchars($row['username']); ?></td>
                                            <td><?php echo htmlspecialchars($row['komentar']); ?></td>
                                            <td><?php echo htmlspecialchars($row['tanggal_komentar']); ?></td>
                                            <td>
                                                <div class="d-flex">
                                                    <a href="javascript:void(0);"
                                                        onclick="confirmDeleteComment(<?php echo htmlspecialchars($row['id_komentar']); ?>)"
    ...
    ***********************************-->
        ...
        <script>
            ...
            function deleteComment(commentId) {
                ...
                xhr.open("POST", "deletekomen.php", true);
                ...
                xhr.onload = function () {
                    if (xhr.status == 200) {
                        if (xhr.responseText.trim() === 'success') {
                            ...
                            Swal.fire({
                                title: 'Error!',
                                text: 'Terjadi kesalahan saat menghapus komentar: ' + xhr.responseText,
                                icon: 'error',
                                confirmButtonText: 'OK'
                            });
                        }
                ...
                xhr.send("id_komentar=" + commentId);
            }
        </script>
