...
<div class="header-bottom sticky-bar">
        ...
        <nav aria-label="breadcrumb">
            <div class="nav-breadcrumb">
                ...
                <span class="separator">/</span>
                <div class="nav-item-active">Kursi Cendana</div>
            </div>
        </nav>  
                        ...
                        <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="assets/pic/pro-zoom/kursi-cendana.png">
                                        <img src="assets/pic/pro-large/kursi-cendana.png" alt="">
                                    </a>
                                </div>
                                <a class="easyzoom-pop-up img-popup" href="assets/pic/Arm_chair/Kursi_Cendana.png">
                    ...
                    <div class="col-lg-6">
                        <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="product-details-meta">
                                <ul>
                                    <li><span class="title">Dimensi :</span>Panjang 93 cm x Kedalaman 97 cm
                                       <li><span class="title">　　　　 </span> Tinggi 72 cm x Tinggi Dudukan 47 cm
                                       </li>
                                    </li>
                                    <li><span class="title">Warna :</span>Abu-Abu </li>
                ...
                <div class="tab-content">
                    <div id="des-details1" class="tab-pane active">
                        <div class="product-description-content text-center">
                            <p data-aos="fade-up" data-aos-delay="500">Kursi Cendana menghadirkan sentuhan elegan dan klasik ke dalam ruang tamu Anda. Dengan desain yang terinspirasi dari gaya klasik, kursi ini memiliki detail kancing yang menarik pada sandaran serta bantalan yang empuk untuk kenyamanan maksimal. </p>
                            <p data-aos="fade-up" data-aos-delay="400"> Ditambah dengan aksen rivet metalik di sepanjang lengan dan bagian depan kursi. Kain beludru berkualitas tinggi dengan warna abu-abu menambah nuansa mewah dan anggun, menjadikan kursi ini pilihan sempurna untuk menciptakan atmosfer yang hangat dan berkelas di rumah Anda.</p>
                        </div>
                    </div>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Panjang 93 cm x Kedalaman 97 cm
                                            Tinggi 72 cm x Tinggi Dudukan 47 cm</td>
                                    </tr>
                                    <tr>
                    ...
                    <div id="des-details3" class="tab-pane">
                        <div class="review-wrapper">
                            <h3>1 komentar untuk Kursi Cendana</h3>
