...
<body>
    ...
    <nav aria-label="breadcrumb">
        <div class="nav-breadcrumb">
            ...
            <span class="separator">/</span>
            <div class="nav-item-active">Meja Bulat Klasik</div>
        </div>
    </nav>
                    ...
                    <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                        <div class="easyzoom-style">
                            <div class="easyzoom easyzoom--overlay">
                                <a href="assets/pic/pro-zoom/meja_bulat_klasik.png">
                                    <img src="assets/pic/pro-large/meja_bulat_klasik.png" alt="">
                                </a>
                            </div>
                            <a class="easyzoom-pop-up img-popup" href="assets/pic/Side_table/Meja_Bulat_Klasik.png">
                ...
                <div class="col-lg-6">
                    <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="product-details-meta">
                            <ul>
                                <li><span class="title">Dimensi :</span> 50 × 50 × 60 cm</li>
                                <li><span class="title">Warna :</span>Coklat</li>
            ...
            <div class="tab-content">
                <div id="des-details1" class="tab-pane active">
                    <div class="product-description-content text-center">
                        <p data-aos="fade-up" data-aos-delay="500">Meja ini memiliki desain yang sederhana namun elegan
                            dengan bentuk bulat dan kaki-kaki yang ramping. Terbuat dari kayu dengan tampilan alami,
                            meja ini cocok untuk berbagai ruangan, termasuk ruang tamu atau ruang santai. </p>
                        <p data-aos="fade-up" data-aos-delay="400"> Selain meja utama, terdapat rak bawah yang dapat
                            digunakan untuk menyimpan majalah atau barang-barang dekoratif kecil.</p>
                    </div>
                </div>
                ...
                <div id="des-details3" class="tab-pane">
                    <div class="review-wrapper">
                        <h3>1 komentar untuk Meja Bulat Klasik</h3>
