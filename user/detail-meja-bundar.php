...
<body>
    ...
    <nav aria-label="breadcrumb">
        <div class="nav-breadcrumb">
            ...
            <span class="separator">/</span>
            <div class="nav-item-active">Meja Bundar</div>
        </div>
    </nav>
                    ...
                    <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                        <div class="easyzoom-style">
                            <div class="easyzoom easyzoom--overlay">
                                <a href="assets/pic/pro-zoom/meja-bundar.png">
                                    <img src="assets/pic/pro-large/meja-bundar.png" alt="">
                                </a>
                            </div>
                            <a class="easyzoom-pop-up img-popup" href="assets/pic/Side_table/meja_bundar.png">
                ...
                <div class="col-lg-6">
                    <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="product-details-meta">
                            <ul>
                                <li><span class="title">Dimensi :</span> 60 × 60 × 75 cm</li>
                                <li><span class="title">Warna :</span>Coklat Kehitaman </li>
            ...
            <div class="tab-content">
                <div id="des-details1" class="tab-pane active">
                    <div class="product-description-content text-center">
                        <p data-aos="fade-up" data-aos-delay="500">Meja ini memiliki desain yang elegan dan sederhana,
                            dengan bentuk bundar yang klasik dan kaki yang ramping. Meja ini terbuat dari kayu dengan
                            sentuhan akhir yang gelap, memberikan tampilan yang hangat dan mewah.</p>
                        <p data-aos="fade-up" data-aos-delay="400"> Kaki-kakinya berbentuk silindris yang menyempit ke
                            arah bawah, dilengkapi dengan aksen logam berwarna emas pada ujung kaki, menambahkan kesan
                            modern pada desain yang vintage. Terdapat juga penyangga silang di antara kaki-kaki meja
                            untuk stabilitas tambahan.</p>
                    </div>
                </div>
                ...
                <div id="des-details3" class="tab-pane">
                    <div class="review-wrapper">
                        <h3>1 komentar untuk Meja Bundar</h3>
                ...
                <div id="pro-1" class="tab-pane active">
                    <div class="row">
                            ...
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                                <div class="product-img img-zoom mb-25">
                                    <a href="detail-meja-silinder.php">
                                        <img src="assets/pic/Side_table/meja_aksen_silinder.png" alt="">
                                    </a>
                                    ...
                                    <div class="product-action-2-wrap">
                                        <button class="product-action-btn-2" title="Add To Cart"
                                            onclick="handleAddToCart(this)" data-id="3" data-name="Meja Aksen Silinder"
                                            data-price="1670000"
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                                <div class="product-img img-zoom mb-25">
                                    <a href="detail-meja-minimalis.php">
                                        <img src="assets/pic/Side_table/meja_minimalis.png" alt="">
                                    </a>
                                    <div class="product-action-wrap">
                                        <a href="detail-meja-minimalis.php" class="product-action-btn-1">
                                            <i class="pe-7s-look"></i>
                                        </a>
                                    </div>
                                    <div class="product-action-2-wrap">
                                        <button class="product-action-btn-2" title="Add To Cart"
                                            onclick="handleAddToCart(this)" data-id="6" data-name="Meja Minimalis"
                                            data-price="1230000" data-image="assets/pic/Side_table/meja_minimalis.png">
                                            <i class="pe-7s-cart"></i> Tambah ke keranjang
                                        </button>
                                    </div>
                                </div>
                                <div class="product-content">
                                    <h3><a href="detail-meja-minimalis.php">Meja Minimalis</a></h3>
                                    <div class="product-price">
                                        <span>Rp1,230,000</span>
                                    </div>
                                </div>
                            </div>
                        </div>
