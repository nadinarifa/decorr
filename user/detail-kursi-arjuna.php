...
<div class="header-bottom sticky-bar">
        ...
        <nav aria-label="breadcrumb">
            <div class="nav-breadcrumb">
                ...
                <span class="separator">/</span>
                <div class="nav-item-active">Kursi Arjuna</div>
            </div>
        </nav>  
                        ...
                        <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="assets/pic/pro-zoom/kursi-arjuna.png">
                                        <img src="assets/pic/pro-large/kursi-arjuna.png" alt="">
                                    </a>
                                </div>
                                <a class="easyzoom-pop-up img-popup" href="assets/pic/Arm_chair/Kursi_Arjuna.png">
                    ...
                    <div class="col-lg-6">
                        <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="product-details-meta">
                                <ul>
                                    <li><span class="title">Dimensi :</span> 85 × 80 × 75 cm</li>
                                    <li><span class="title">Warna :</span>Hijau Tua</li>
                                    <li><span class="title">Nama Kain :</span>korduroi</li>                          
                            </div>
                ...
                <div class="tab-content">
                    <div id="des-details1" class="tab-pane active">
                        <div class="product-description-content text-center">
                            <p data-aos="fade-up" data-aos-delay="500">kursi santai dengan desain modern yang menawarkan kenyamanan optimal. Dengan sandaran yang lebar dan bantalan empuk di bagian lengan serta dudukan, kursi ini dirancang untuk relaksasi. Bentuknya yang bulat dan tebal membuatnya terlihat nyaman, cocok ditempatkan di ruang tamu atau ruang keluarga.</p>
                        </div>
                    </div>
                    ...
                    <div id="des-details3" class="tab-pane">
                        <div class="review-wrapper">
                            <h3>1 komentar untuk Kursi Arjuna</h3>
