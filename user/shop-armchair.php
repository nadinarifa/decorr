...
// Ganti ID kategori dengan ID yang sesuai untuk kategori Kursi
$id_kategori_kursi = 2; // ID kategori Kursi adalah 2 (ubah jika perlu)

// Query untuk menghitung jumlah produk di kategori Kursi
$sql_count = "SELECT COUNT(*) AS total_produk FROM tb_produk WHERE id_kategori = $id_kategori_kursi";
...
// Query untuk menampilkan produk dalam kategori Kursi
$sql = "SELECT * FROM tb_produk WHERE id_kategori = $id_kategori_kursi";
$result = $conn->query($sql);

$products = [];
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $nama_produk_singkat = str_replace(' Kursi', '', $row['nama_produk']);

        // Menambahkan informasi diskon dan produk baru
        $diskon = $row['diskon'] ? $row['diskon'] : null; // Jika ada diskon
        $products[] = [
            ...
            <div class="row flex-row-reverse">
                <div class="col-12">
                    <div class="content-breadcrumb">
                        ...
                        <div class="content-item-active">Kursi</div>
                    </div>
                    <br><br>
                    <section class="content">
                        <hr><br>
                        <!-- Menampilkan jumlah produk di kategori Kursi -->
                                    ...
                                    <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                                        <div class="product-img img-zoom mb-25">
                                            ...
                                            <?php if ($product['diskon']): ?>
                                                ...
                                                $harga_baru = $harga_lama - ($harga_lama * ($product['diskon'] / 100));
                                                ?>
                                            ...
                                            <div class="product-action-wrap">
                                                <!-- Quickview mengarah ke halaman produk yang tepat -->
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 mb-30 text-left">
                            ...
                            <div class="footer-widget footer-about">
                                <p>Kami di <strong>Décor</strong> berkomitmen untuk menghadirkan
                                    sentuhan estetika terbaik di setiap sudut ruang Anda. Bersama-sama,
                                    kita membuat rumah lebih dari sekadar tempat tinggal — sebuah
                                    ekspresi diri.</p>
                            </div>
                        </div>
