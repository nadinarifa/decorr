...
<div class="header-bottom sticky-bar">
        ...
        <nav aria-label="breadcrumb">
            <div class="nav-breadcrumb">
                ...
                <div><a href="shop-armchair.html" class="nav-item">Kursi</a></div>
                <span class="separator">/</span>
                <div class="nav-item-active">Kursi Jade</div>
            </div>
        </nav>  
                        ...
                        <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="assets/pic/pro-zoom/pro-zoom-8.png">
                                        <img src="assets/pic/pro-large/pro-large-8.png" alt="">
                                    </a>
                                </div>
                                <a class="easyzoom-pop-up img-popup" href="assets/pic/Arm_chair/Kursi_Jade.png">
                    ...
                    <div class="col-lg-6">
                        <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="product-details-price">
                                <span class="old-price">Rp350.000 </span>
                                <span class="new-price">Rp299.000</span>
                            </div>
                            <div class="product-details-meta">
                                <ul>
                                    <li><span class="title">Dimensi :</span> 75× 86 × 78 cm</li>
                                    <li><span class="title">Warna :</span>Hijau </li>
                ...
                <div class="tab-content">
                    <div id="des-details1" class="tab-pane active">
                        <div class="product-description-content text-center">
                            <p data-aos="fade-up" data-aos-delay="500">Kursi ini memiliki desain elegan dengan bentuk melengkung dan bantalan tebal, sehingga memberikan kenyamanan ekstra. Kursi ini dilengkapi dengan sandaran punggung dan bantalan kursi yang empuk, sehingga memberikan dukungan yang baik saat duduk. Kakinya terbuat dari logam berlapis emas, sehingga memberikan kesan mewah dan kontras yang menarik dengan warna kainnya.</p>
                            <p data-aos="fade-up" data-aos-delay="400">Rangka kursi terbuat dari kayu mahoni, yang terkenal akan kekuatan, keawetan, dan kualitasnya yang tinggi. Kayu ini memberikan kestabilan dan keawetan pada furnitur, menjadikannya pilihan ideal untuk kursi dengan desain mewah dan fungsionalitas yang tahan lama.</p>
                        </div>
                    </div>
                    ...
                    <div id="des-details3" class="tab-pane">
                        <div class="review-wrapper">
                            <h3>1 komentar untuk Kursi Lounge Berlapis Kain</h3>
                            ...
                            <div class="product-wrap" data-aos="fade-up" data-aos-delay="200">
                                <div class="product-img img-zoom mb-25">
                                        ...
                                        <div class="product-action-wrap">
                                            <a href="detail-meja-rotan.html" class="product-action-btn-1">
                                ...
                                <div class="product-content">
                                    <h3><a href="detail-meja-kerucut.html">Meja Kerucut</a></h3>
