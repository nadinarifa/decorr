...
<div class="header-bottom sticky-bar">
        ...
        <nav aria-label="breadcrumb">
            <div class="nav-breadcrumb">
                ...
                <span class="separator">/</span>
                <div class="nav-item-active">Kursi Junot</div>
            </div>
        </nav>  
                        ...
                        <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="assets/pic/pro-zoom/kursi-junot.png">
                                        <img src="assets/pic/pro-large/kursi-junot.png" alt="">
                                    </a>
                                </div>
                                <a class="easyzoom-pop-up img-popup" href="assets/pic/Arm_chair/Kursi_Junot.png">
                    ...
                    <div class="col-lg-6">
                        <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="product-details-price">
                                <span>Rp4,380,000</span>
                            </div>
                            <div class="product-details-meta">
                                <ul>
                                    <li><span class="title">Dimensi :</span>80 × 75 × 80 cm</li>
                                    <li><span class="title">Warna :</span>Abu-Abu Netral </li>
                                    <li><span class="title">Nama Kain :</span>Poliester</li>                          
                            </div>
                ...
                <div class="tab-content">
                    <div id="des-details1" class="tab-pane active">
                        <div class="product-description-content text-center">
                            <p data-aos="fade-up" data-aos-delay="500">Kursi ini memiliki desain minimalis dengan bentuk yang sederhana namun fungsional. Sandaran melengkung memberikan dukungan punggung yang nyaman, sementara dudukan yang empuk menjadikan kursi ini cocok untuk relaksasi atau duduk santai. </p>
                            <p data-aos="fade-up" data-aos-delay="400">Rangka kayu yang terlihat pada bagian lengan hingga kaki kursi memberikan kesan alami dan solid. Desainnya cocok ditempatkan di berbagai jenis interior, dari klasik hingga modern. </p>
                        </div>
                    </div>
                    ...
                    <div id="des-details3" class="tab-pane">
                        <div class="review-wrapper">
                            <h3>1 komentar untuk Kursi Junot</h3>
