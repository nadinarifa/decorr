...
<div class="header-bottom sticky-bar">
        ...
        <nav aria-label="breadcrumb">
            <div class="nav-breadcrumb">
                ...
                <span class="separator">/</span>
                <div class="nav-item-active">Kursi Cangkang</div>
            </div>
        </nav>  
                ...
                <div class="row">
                        ...
                        <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="assets/pic/pro-zoom/kursi-cangkang.png">
                                        <img src="assets/pic/pro-large/kursi-cangkang.png" alt="">
                                    </a>
                                </div>
                                <a class="easyzoom-pop-up img-popup" href="assets/pic/Arm_chair/Kursi_Cangkang.png">
                    ...
                    <div class="col-lg-6">
                        <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                            <h2>Kursi Cangkang</h2>
                            <div class="product-details-price">
                                <span>Rp3,970,000</span>
                            </div>
                            <div class="product-details-meta">
                                <ul>
                                    <li><span class="title">Dimensi :</span>75 × 70 × 85 cm</li>
                                    <li><span class="title">Warna :</span>Pink Muda </li>
                ...
                <div class="tab-content">
                    <div id="des-details1" class="tab-pane active">
                        <div class="product-description-content text-center">
                            <p data-aos="fade-up" data-aos-delay="500">Kursi ini memiliki desain elegan dengan sandaran berbentuk seperti cangkang kerang. Sandaran yang melengkung memberi kesan artistik, sekaligus memberikan dukungan nyaman untuk punggung. Bentuk bulat pada dudukan kursi memperkuat kesan mewah dan cocok ditempatkan di ruangan dengan gaya klasik atau glamor. Kaki kursi yang ramping memberikan sentuhan modern dan membuat kursi ini terlihat ringan dan anggun. </p>
                        </div>
                    </div>
                    ...
                    <div id="des-details3" class="tab-pane">
                        <div class="review-wrapper">
                            <h3>1 komentar untuk Kursi Cangkang</h3>
