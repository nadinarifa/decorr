...
$id_produk = 2; // Ganti dengan ID produk yang sesuai
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <div class="nav-breadcrumb">
            ...
            <div><a href="shop-sofas.php" class="nav-item">Sofa</a></div>
            <span class="separator">/</span>
            <div class="nav-item-active">Lylia Sofa</div>
        </div>
    </nav>
                    ...
                    <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                        <div class="easyzoom-style">
                            <div class="easyzoom easyzoom--overlay">
                                <a href="assets/pic/pro-zoom/lylia-sofa.png">
                                    <img src="assets/pic/pro-large/lylia-sofa.png" alt="">
                                </a>
                            </div>
                            <a class="easyzoom-pop-up img-popup" href="assets/pic/sofas/Lylia_sofa.png">
                ...
                <div class="col-lg-6">
                    <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="product-details-meta">
                            <ul>
                                <li><span class="title">Dimensi :</span>Panjang 280 cm x Kedalaman 90 cm
                                <li><span class="title">　　　　  </span>Tinggi 79 cm x Tinggi Dudukan 42 cm
                                </li>
                                <li><span class="title">Warna :</span>Coklat & Cream </li>
                                <li><span class="title">Nama Kain :</span>Beludru</li>
                        </div>
            ...
            <div class="tab-content">
                <div id="des-details1" class="tab-pane active">
                    <div class="product-description-content text-center">
                        <p data-aos="fade-up" data-aos-delay="500">Sofa berbentuk bulan sabit melengkung kami memberikan
                            tampilan modern dan menarik. Sisi dalam sandaran memiliki detail rumbai yang elegan, yang
                            menunjukkan sentuhan pengerjaan tradisional.</p>
                        <p data-aos="fade-up" data-aos-delay="400"> Lengkungan sofa yang seragam menunjukkan konstruksi
                            yang halus dan mulus tanpa sudut yang jelas. Bantalan kursi yang memanjang menunjukkan
                            permukaan kenyamanan tunggal yang tidak terputus yang diisi dengan bahan bantalan
                            berkualitas. Bagian ini memiliki perpaduan unik antara elemen modern dan tradisional, yang
                            membuatnya serbaguna.</p>
                    </div>
                </div>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td>Panjang 280 cm x Kedalaman 90 cm x Tinggi 79 cm x Tinggi Dudukan 42 cm</td>
                                </tr>
                                <tr>
                ...
                <div id="pro-1" class="tab-pane active">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                                <div class="product-img img-zoom mb-25">
                                    <a href="detail-sofa-ardena.php">
                                        <img src="assets/pic/sofas/Ardena_sofa.png" alt="">
                                    </a>
                                    <div class="product-action-wrap">
                                        <a href="detail-sofa-ardena.php" class="product-action-btn-1">
                                            <i class="pe-7s-look"></i>
                                        </a>
                                    </div>
                                    <div class="product-action-2-wrap">
                                        <button class="product-action-btn-2" title="Add To Cart"
                                            onclick="handleAddToCart(this)" data-id="3" data-name="Ardena Sofa"
                                            data-price="8590000" data-image="assets/pic/sofas/Ardena_sofa.png">
                                            <i class="pe-7s-cart"></i> Tambah ke keranjang
                                        </button>
                                    </div>
                                </div>
                                <div class="product-content">
                                    <h3><a href="detail-sofa-ardena.php">Ardena Sofa</a></h3>
                                    <div class="product-price">
                                        <span>Rp8,590,000</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                                <div class="product-img img-zoom mb-25">
                                    <a href="detail-sofa-kanza.php">
                                        <img src="assets/pic/sofas/Kanza_sofa.png" alt="">
                                    </a>
                                    <div class="product-action-wrap">
                                        <a href="detail-sofa-kanza.php" class="product-action-btn-1">
                                            <i class="pe-7s-look"></i>
                                        </a>
                                    </div>
                                    <div class="product-action-2-wrap">
                                        <button class="product-action-btn-2" title="Add To Cart"
                                            onclick="handleAddToCart(this)" data-id="4" data-name="Kanza Sofa"
                                            data-price="13589000" data-image="assets/pic/sofas/Kanza_sofa.png">
                                            <i class="pe-7s-cart"></i> Tambah ke keranjang
                                        </button>
                                    </div>
                                </div>
                                <div class="product-content">
                                    <h3><a href="detail-sofa-kanza.php">Kanza Sofa</a></h3>
                                    <div class="product-price">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                                <div class="product-img img-zoom mb-25">
                                    <a href="detail-sofa-grahma.php">
                                        <img src="assets/pic/sofas/Grahma_sofa.png" alt="">
                                    </a>
                                    <div class="product-action-wrap">
                                        <a href="detail-sofa-grahma.php" class="product-action-btn-1">
                                            <i class="pe-7s-look"></i>
                                        </a>
                                    </div>
                                    <div class="product-action-2-wrap">
                                        <button class="product-action-btn-2" title="Add To Cart"
                                            onclick="handleAddToCart(this)" data-id="5" data-name="Grahma Sofa"
                                            data-price="7463000" data-image="assets/pic/sofas/Grahma_sofa.png">
                                            <i class="pe-7s-cart"></i> Tambah ke keranjang
                                        </button>
                                    </div>
                                </div>
                                <div class="product-content">
                                    <h3><a href="detail-sofa-grahma.php">Grahma Sofa</a></h3>
                                    <div class="product-price">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                                <div class="product-img img-zoom mb-25">
                                    <a href="detail-sofa-fayhimi.php">
                                        <img src="assets/pic/sofas/fayhimi_sofa.png" alt="">
                                    </a>
                                    <div class="product-action-wrap">
                                        <a href="detail-sofa-fayhimi.php" class="product-action-btn-1">
                                            <i class="pe-7s-look"></i>
                                        </a>
                                    </div>
                                    <div class="product-action-2-wrap">
                                        <button class="product-action-btn-2" title="Add To Cart"
                                            onclick="handleAddToCart(this)" data-id="6" data-name="Fayhimi Sofa"
                                            data-price="15800000" data-image="assets/pic/sofas/fayhimi_sofa.png">
                                            <i class="pe-7s-cart"></i> Tambah ke keranjang
                                        </button>
                                    </div>
                                </div>
                                <div class="product-content">
                                    <h3><a href="detail-sofa-fayhimi.php">Fayhimi Sofa</a></h3>
                                    <div class="product-price">
                                        ...
                                        <div class="footer-widget footer-address">
                                            ...
                                            <ul>
                                                ...
                                                <li><span>Email: </span><a
                                                        href="mailto:decor@gmail.com">decor@gmail.com</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
