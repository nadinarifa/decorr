...
<body>
    <div class="login-container">
        <div class="login-section">
            ...
            <h2 class="login-subtitle">Kembali</h2>
            <br>
            <form class="login-form" action="login.php" method="POST">
                <div class="form-group">
                    <input type="email" class="login-input" name="email" id="email" placeholder=" " required>
            ...
            <p class="login-prompt">Belum punya akun? <a href="register_form.php">Daftar</a></p>
        </div>
    </div>
