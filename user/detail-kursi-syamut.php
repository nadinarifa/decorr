...
<div class="header-bottom sticky-bar">
        ...
        <nav aria-label="breadcrumb">
            <div class="nav-breadcrumb">
                ...
                <span class="separator">/</span>
                <div class="nav-item-active">Kursi Syamut</div>
            </div>
        </nav>  
                        ...
                        <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="assets/pic/pro-zoom/kursi-syamut.png">
                                        <img src="assets/pic/pro-large/kursi-syamut.png" alt="">
                                    </a>
                                </div>
                                <a class="easyzoom-pop-up img-popup" href="assets/pic/Arm_chair/Kursi_Syamut.png">
                    ...
                    <div class="col-lg-6">
                        <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="product-details-meta">
                                <ul>
                                    <li><span class="title">Dimensi :</span>70 × 69 × 66 cm</li>
                ...
                <div class="tab-content">
                    <div id="des-details1" class="tab-pane active">
                        <div class="product-description-content text-center">
                            <p data-aos="fade-up" data-aos-delay="500">Kursi kompak dengan profil rendah. Desain sandaran dan tempat duduk yang halus dan membulat. Kaki kayu yang pendek dan melebar. Ideal untuk sudut yang nyaman atau sebagai aksen. </p>
                        </div>
                    </div>
                    ...
                    <div id="des-details3" class="tab-pane">
                        <div class="review-wrapper">
                            <h3>1 komentar untuk Kursi Syamut</h3>
