...
<body>
    ...
    <nav aria-label="breadcrumb">
        <div class="nav-breadcrumb">
            ...
            <span class="separator">/</span>
            <div class="nav-item-active">Meja Sisi Rotan</div>
        </div>
    </nav>
                    ...
                    <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                        <div class="easyzoom-style">
                            <div class="easyzoom easyzoom--overlay">
                                <a href="assets/pic/pro-zoom/meja-sisi-rotan.png">
                                    <img src="assets/pic/pro-large/meja-sisi-rotan.png" alt="">
                                </a>
                            </div>
                            <a class="easyzoom-pop-up img-popup" href="assets/pic/Side_table/meja_sisi_rotan.png">
                ...
                <div class="col-lg-6">
                    <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="product-details-meta">
                            <ul>
                                <li><span class="title">Dimensi :</span> 40 × 40 × 55 cm</li>
                                <li><span class="title">Warna :</span>Hitam, Cream </li>
                                <li><span class="title">Nama Kayu :</span>Mahoni</li>
                        </div>
            ...
            <div class="tab-content">
                <div id="des-details1" class="tab-pane active">
                    <div class="product-description-content text-center">
                        <p data-aos="fade-up" data-aos-delay="500">Meja Sisi Rotan Hitam adalah pilihan elegan dan
                            fungsional untuk melengkapi ruang tamu atau kamar tidur Anda. Meja ini memiliki desain
                            modern dengan kombinasi rotan alami pada sisi-sisinya dan permukaan meja berwarna hitam yang
                            ramping.</p>
                        <p data-aos="fade-up" data-aos-delay="400"> Dengan dua tingkat penyimpanan, meja ini ideal untuk
                            menaruh buku, lampu, atau dekorasi kecil lainnya. Kaki meja yang kokoh dilengkapi dengan
                            ujung berwarna emas, menambahkan sentuhan mewah pada desainnya.</p>
                    </div>
                </div>
                ...
                <div id="des-details3" class="tab-pane">
                    <div class="review-wrapper">
                        <h3>1 komentar untuk Meja Sisi Rotan</h3>
