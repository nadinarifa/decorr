...
$id_produk = 5; // Ganti dengan ID produk yang sesuai
...
<div class="header-bottom sticky-bar">
        ...
        <nav aria-label="breadcrumb">
            <div class="nav-breadcrumb">
                ...
                <span class="separator">/</span>
                <div class="nav-item-active">Fayhimi Sofa</div>
            </div>
        </nav>  
                        ...
                        <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="assets/pic/pro-zoom/fayhimi-sofa.png">
                                        <img src="assets/pic/pro-large/fayhimi-sofa.png" alt="">
                                    </a>
                                </div>
                                <a class="easyzoom-pop-up img-popup" href="assets/pic/sofas/fayhimi_sofa.png">
                    ...
                    <div class="col-lg-6">
                        <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="product-details-meta">
                                <ul>
                                        <li><span class="title">Dimensi :</span>Panjang 206 cm x Kedalaman 85 cm
                                           <li><span class="title">　　　　  </span> Tinggi 75 cm x Tinggi Dudukan 49 cm
                                           </li>
                                    <li><span class="title">Warna :</span>Cream </li>
                ...
                <div class="tab-content">
                    <div id="des-details1" class="tab-pane active">
                        <div class="product-description-content text-center">
                            <p data-aos="fade-up" data-aos-delay="500">Desain klasik yang elegan dengan lengan yang digulung. Bantal punggung yang longgar dengan isian premium dilengkapi dengan aksen trim paku payung. Didukung oleh kaki kayu sederhana untuk dukungan yang baik. </p>
                        </div>
                    </div>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Panjang 206 cm x Kedalaman 85 cm
                                            Tinggi 75 cm x Tinggi Dudukan 49 cm
                           </td>
                                    </tr>
                                    <tr>
                    ...
                    <div id="des-details3" class="tab-pane">
                        <div class="review-wrapper">
                            <h3>1 komentar untuk Fayhimi Sofa</h3>
