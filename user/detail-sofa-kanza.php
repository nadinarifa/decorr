...
$id_produk = 3; // Ganti dengan ID produk yang sesuai
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <div class="nav-breadcrumb">
            ...
            <span class="separator">/</span>
            <div class="nav-item-active">Kanza Sofa</div>
        </div>
    </nav>
                    ...
                    <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                        <div class="easyzoom-style">
                            <div class="easyzoom easyzoom--overlay">
                                <a href="assets/pic/pro-zoom/kanza-sofa.png">
                                    <img src="assets/pic/pro-large/kanza-sofa.png" alt="">
                                </a>
                            </div>
                            <a class="easyzoom-pop-up img-popup" href="assets/pic/sofas/Kanza_sofa.png">
                ...
                <div class="col-lg-6">
                    <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="product-details-meta">
                            <ul>
                                <li><span class="title">Dimensi :</span>Panjang 252 cm x Kedalaman 94 cm
                                <li><span class="title">　　　　  </span>Tinggi 62 cm x Tinggi Dudukan 41 cm
                                </li>
                                <li><span class="title">Warna :</span>Coklat Muda</li>
                                <li><span class="title">Nama Kain :</span>Oscar</li>
                        </div>
            ...
            <div class="tab-content">
                <div id="des-details1" class="tab-pane active">
                    <div class="product-description-content text-center">
                        <p data-aos="fade-up" data-aos-delay="500">Desain modern dengan bentuk yang ramping. Bantal
                            punggung yang empuk untuk kenyamanan. Dua bantal kursi yang besar menyediakan ruang duduk
                            yang cukup. Sandaran tangan berbentuk kotak yang merupakan perpanjangan dari struktur sofa.
                        </p>
                    </div>
                </div>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td>Panjang 252 cm x Kedalaman 94 cm
                                        Tinggi 62 cm x Tinggi Dudukan 41 cm
                ...
                <div id="pro-1" class="tab-pane active">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                                <div class="product-img img-zoom mb-25">
                                    <a href="detail-sofa-lylia.php">
                                        <img src="assets/pic/sofas/Lylia_sofa.png" alt="">
                                    </a>
                                    <div class="product-action-wrap">
                                        <a href="detail-sofa-lylia.php" class="product-action-btn-1">
                                            <i class="pe-7s-look"></i>
                                        </a>
                                    </div>
                                    <div class="product-action-2-wrap">
                                        <button class="product-action-btn-2" title="Add To Cart"
                                            onclick="handleAddToCart(this)" data-id="2" data-name="Lylia Sofa"
                                            data-price="12000000" data-image="assets/pic/sofas/Lylia_sofa.png">
                                            <i class="pe-7s-cart"></i> Tambah ke keranjang
                                        </button>
                                    </div>
                                </div>
                                <div class="product-content">
                                    <h3><a href="detail-sofa-lylia.php">Lylia Sofa</a></h3>
                                    <div class="product-price">
