...
<body>
    ...
    <nav aria-label="breadcrumb">
        <div class="nav-breadcrumb">
            ...
            <span class="separator">/</span>
            <div class="nav-item-active">Meja Kerucut</div>
        </div>
    </nav>
                    ...
                    <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                        <div class="easyzoom-style">
                            <div class="easyzoom easyzoom--overlay">
                                <a href="assets/pic/pro-zoom/meja-vintage.png">
                                    <img src="assets/pic/pro-large/meja-vintage.png" alt="">
                                </a>
                            </div>
                            <a class="easyzoom-pop-up img-popup" href="assets/pic/Side_table/meja_vintage.png">
                ...
                <div class="col-lg-6">
                    <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="product-details-meta">
                            <ul>
                                <li><span class="title">Dimensi :</span> 40 × 40 × 65 cm</li>
                                <li><span class="title">Warna :</span>Beige </li>
            ...
            <div class="tab-content">
                <div id="des-details1" class="tab-pane active">
                    <div class="product-description-content text-center">
                        <p data-aos="fade-up" data-aos-delay="500">Meja ini memiliki desain yang klasik dan elegan
                            dengan kaki tunggal yang melengkung di bagian bawah, memberikan stabilitas serta sentuhan
                            tradisional. Warnanya putih gading dengan sedikit efek distressed, cocok untuk digunakan
                            sebagai meja aksen di ruang tamu, kamar tidur, atau ruang keluarga. </p>
                        <p data-aos="fade-up" data-aos-delay="400">Meja ini juga dilengkapi dengan satu laci kecil yang
                            terletak di bawah permukaan meja, sangat praktis untuk menyimpan barang-barang kecil seperti
                            kunci atau pernak-pernik.</p>
                    </div>
                </div>
                ...
                <div id="des-details3" class="tab-pane">
                    <div class="review-wrapper">
                        <h3>1 komentar untuk Meja Vintage</h3>
