...
<body>
    ...
    <nav aria-label="breadcrumb">
        <div class="nav-breadcrumb">
            ...
            <span class="separator">/</span>
            <div class="nav-item-active">Meja Minimalis</div>
        </div>
    </nav>
                    ...
                    <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                        <div class="easyzoom-style">
                            <div class="easyzoom easyzoom--overlay">
                                <a href="assets/pic/pro-zoom/meja-minimalis.png">
                                    <img src="assets/pic/pro-large/meja-minimalis.png" alt="">
                                </a>
                            </div>
                            <a class="easyzoom-pop-up img-popup" href="assets/pic/Side_table/meja_minimalis.png">
                ...
                <div class="col-lg-6">
                    <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="product-details-meta">
                            <ul>
                                <li><span class="title">Dimensi :</span> 60 × 60 × 45 cm</li>
            ...
            <div class="tab-content">
                <div id="des-details1" class="tab-pane active">
                    <div class="product-description-content text-center">
                        <p data-aos="fade-up" data-aos-delay="500">Meja ini memiliki desain sederhana namun elegan
                            dengan permukaan bulat yang datar dan kaki tiga yang ramping namun kokoh. Meja ini
                            didominasi oleh warna hitam matte, menjadikannya pilihan yang serbaguna untuk berbagai gaya
                            dekorasi, mulai dari modern hingga industrial. Struktur kakinya terbuat dari material logam
                            atau kayu yang diproses, memberikan stabilitas dan daya tahan yang baik. Cocok digunakan
                            sebagai meja kopi atau meja samping di ruang tamu.</p>
                    </div>
                </div>
                ...
                <div id="des-details3" class="tab-pane">
                    <div class="review-wrapper">
                        <h3>1 komentar untuk Meja Minimalis</h3>
