...
$id_produk = 6; // Ganti dengan ID produk yang sesuai
...
<div class="header-bottom sticky-bar">
        ...
        <nav aria-label="breadcrumb">
            <div class="nav-breadcrumb">
                ...
                <span class="separator">/</span>
                <div class="nav-item-active">Ardena Sofa</div>
            </div>
        </nav>  
                        ...
                        <div class="product-details-img-wrap" data-aos="fade-up" data-aos-delay="200">
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="assets/pic/pro-zoom/ardena-sofa.png">
                                        <img src="assets/pic/pro-large/ardena-sofa.png" alt="">
                                    </a>
                                </div>
                                <a class="easyzoom-pop-up img-popup" href="assets/pic/sofas/Ardena_sofa.png">
                    ...
                    <div class="col-lg-6">
                        <div class="product-details-content" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="product-details-meta">
                                <ul>
                                        <li><span class="title">Dimensi :</span>Panjang 240 cm x Kedalaman 95 cm
                                           <li><span class="title">　　　　  </span>Tinggi 80 cm x Tinggi Dudukan 48 cm
                                           </li>
                ...
                <div class="tab-content">
                    <div id="des-details1" class="tab-pane active">
                        <div class="product-description-content text-center">
                            <p data-aos="fade-up" data-aos-delay="500">Sofa modern dan elegan dengan tiga bantalan dudukan panjang dan tiga bantalan punggung. Sofa ini memiliki lengkungan halus pada sandaran tangan dan ditopang oleh empat kaki kayu. Desain sofa ini memadukan kenyamanan dengan estetika yang bagus, menjadikannya pelengkap yang sempurna untuk ruang tamu.</p>
                        </div>
                    </div>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Panjang 240 cm x Kedalaman 95 cm
                                            Tinggi 80 cm x Tinggi Dudukan 48 cm                          
                    ...
                    <div id="pro-1" class="tab-pane active">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                                    <div class="product-img img-zoom mb-25">
                                        <a href="detail-sofa-grahma.html">
                                            <img src="assets/pic/sofas/Grahma_sofa.png" alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <a href="detail-sofa-grahma.html" class="product-action-btn-1">
                                                <i class="pe-7s-look"></i>
                                            </a>
                                        </div>
                                        <div class="product-action-2-wrap">
                                    ...
                                    <div class="product-content">
                                        <h3><a href="detail-sofa-grahma.html">Grahma Sofa</a></h3>
                                        <div class="product-price">
