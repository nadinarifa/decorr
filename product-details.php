<?php
// Koneksi ke database
include 'includes/db.php'; // Pastikan nama dan path file koneksi database benar

// Query SQL untuk mengambil data produk dan kategori menggunakan JOIN
$id_produk = $_GET['id']; // Asumsikan id produk diambil dari URL
$query = "
    SELECT 
        p.id_produk, p.nama_produk, p.stok, p.diskon, p.harga, p.deskripsi, p.foto_produk,
...
$stmt->bind_param('i', $id_produk); // 'i' menandakan tipe data integer
$stmt->execute();
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-xxl-5">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade show active" id="first">
                                            <img class="img-fluid"
                                                src="assets/pic/<?php echo htmlspecialchars($product['foto_produk']); ?>"
                                                alt="<?php echo htmlspecialchars($product['nama_produk']); ?>">
                                        </div>
                                    </div>
                                    <div class="tab-slide-content new-arrival-product mb-4 mb-xl-0">
                                        <!-- Nav tabs (jika ada, bisa ditambahkan) -->
                                    </div>
                                </div>
                                <div class="col-xl-9 col-lg-6 col-md-6 col-xxl-7 col-sm-12">
                                    <div class="product-detail-content">
                                        ...
                                        <div class="new-arrival-content pr">
                                            ...
                                            <p>Stok: <span
                                                    class="item"><?php echo htmlspecialchars($product['stok']); ?></span>
                                            </p>
                                            <p>Diskon: <span
                                                    class="item"><?php echo htmlspecialchars($product['diskon']); ?>%</span>
                                            </p>
                                            <div class="comment-review star-rating">
                                                <span
                                                    class="review-text">(<?php echo htmlspecialchars($product['jumlah_review'] ?? 0); ?>
                                                    reviews)</span>
                                            </div>
                                            ...
                                            <p>Kategori:&nbsp;&nbsp;
                                                <span
                                                    class="badge badge-success light"><?php echo htmlspecialchars($product['nama_kategori']); ?></span>
                                            </p>
