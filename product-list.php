<?php
// Menghubungkan ke database db_d-ecor
$host = "localhost"; // Sesuaikan dengan host database Anda
$user = "root"; // Sesuaikan dengan user database Anda
$password = ""; // Sesuaikan dengan password database Anda
$database = "db_decor"; // Nama database yang digunakan
...
$query = "SELECT tb_produk.*, tb_kategori.nama_kategori FROM tb_produk
...
<body>
                            ...
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                        <tr data-id="<?php echo htmlspecialchars($row['id_produk']); ?>">
                                            <td><?php echo htmlspecialchars($row['id_produk']); ?></td>
                                            <td>
                                                <img src="assets/pic/<?php echo !empty($row['foto_produk']) ? $row['foto_produk'] : 'default-image.jpg'; ?>"
                                                    alt="product" style="width: 50px; height: auto;">
                                            </td>
                                            <td><?php echo htmlspecialchars($row['nama_produk']); ?></td>
                                            <td><?php echo htmlspecialchars($row['nama_kategori']); ?></td>
                                            <td>Rp<?php echo number_format($row['harga'], 0, ',', '.'); ?></td>
                                            <td><?php echo $row['diskon'] > 0 ? $row['diskon'] . "%" : "Tidak Ada"; ?>
                                            </td>
                                            <td>
                                                <?php
                                                if ($row['diskon'] > 0) {
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="product-details.php?id=<?php echo $row['id_produk']; ?>"
                                                        class="btn btn-info shadow btn-xs sharp me-2">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <a href="editproduct.php?id=<?php echo $row['id_produk']; ?>"
                                                        class="btn btn-warning shadow btn-xs sharp me-2">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="javascript:void(0);"
                                                        onclick="confirmDeleteProduct(<?php echo $row['id_produk']; ?>)"
    ...
    ***********************************-->
    ...
    <script>
        ...
        // Fungsi untuk menghapus produk melalui AJAX
        function deleteProduct(productId) {
            var xhr = new XMLHttpRequest();
            xhr.open("POST", "deleteproduct.php", true); // Mengarah ke file deleteproduct.php
            xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");

            xhr.onload = function () {
                if (xhr.status == 200) {
                    console.log(xhr.responseText); // Menampilkan respons untuk debugging
                    if (xhr.responseText.trim() === 'success') {
                        ...
                        Swal.fire({
                            title: 'Error!',
                            text: 'Terjadi kesalahan saat menghapus produk: ' + xhr.responseText,
                            icon: 'error',
                            confirmButtonText: 'OK'
                        });
                    }
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Terjadi kesalahan server. Status: ' + xhr.status,
                        icon: 'error',
                        confirmButtonText: 'OK'
                    });
                }
            ...
            // Mengirim permintaan dengan ID produk yang akan dihapus
            xhr.send("id_produk=" + productId);
        }

        $(document).ready(function () {
            $('#example3').DataTable(); // Inisialisasi DataTable
        });
    </script>
