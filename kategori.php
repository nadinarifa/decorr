...
// Mengambil semua data dari tb_kategori dan mengurutkan berdasarkan id_kategori secara menurun
$sql = "SELECT id_kategori, nama_kategori FROM tb_kategori ORDER BY id_kategori DESC";
...
<body>
    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-end mb-3">
                <a href="addkategori.php" class="btn btn-primary btn-sm">
                                ...
                                <tbody>
                                    <?php if ($result->num_rows > 0): ?>
                                        <?php while ($row = $result->fetch_assoc()): ?>
                                            <tr data-id="<?php echo htmlspecialchars($row['id_kategori']); ?>">
                                                <td><?php echo htmlspecialchars($row['id_kategori']); ?></td>
                                                <td><?php echo htmlspecialchars($row['nama_kategori']); ?></td>
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="editkategori.php?id=<?php echo htmlspecialchars($row['id_kategori']); ?>"
                                                            class="btn btn-warning shadow btn-xs sharp me-2">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <a href="javascript:void(0);"
                                                            onclick="confirmDeleteCategory(<?php echo htmlspecialchars($row['id_kategori']); ?>)"
    ...
    ***********************************-->
    ...
    <script>
        // Fungsi untuk konfirmasi penghapusan kategori
        ...
        function deleteCategory(categoryId) {
            ...
            xhr.open("POST", "deletekategori.php", true); // Mengarah ke file deletekategori.php
                ...
                if (xhr.status == 200) {
                    ...
                    if (xhr.responseText.trim() === 'success') {
                        Swal.fire({
                            ...
                            // Hapus baris kategori dari tabel setelah berhasil dihapus
                            document.querySelector(`tr[data-id='${categoryId}']`).remove();
                        });
                    } else {
                        Swal.fire({
                            title: 'Error!',
                            text: 'Terjadi kesalahan saat menghapus kategori: ' + xhr.responseText,
                            icon: 'error',
                            confirmButtonText: 'OK'
                        });
                    }
            ...
            // Mengirim permintaan dengan ID kategori yang akan dihapus
            xhr.send("id_kategori=" + categoryId);
        }
    </script>
